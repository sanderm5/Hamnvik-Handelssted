...
// Gjenbrukbar seksjon-definisjon
const sectionFields = [
  {
...
const pageHeaderFields = [
  { type: 'string' as const, name: 'heading', label: 'Overskrift', required: true },
  { type: 'string' as const, name: 'deck', label: 'Undertittel' },
  { type: 'string' as const, name: 'byline', label: 'Byline' },
  {
    type: 'string' as const,
    name: 'intro',
    label: 'Intro',
    ...
    collections: [
      // === SINGLETONS (én fil per side) ===
      {
        ...
        fields: [
          ...pageHeaderFields,
          {
            type: 'string',
            name: 'bodyText1',
            label: 'Brødtekst avsnitt 1',
            ui: { component: 'textarea' },
          },
          {
            type: 'string',
            name: 'bodyText2',
            label: 'Brødtekst avsnitt 2',
            ui: { component: 'textarea' },
          },
          {
            type: 'string',
          ...
          },
          {
            ...
            label: 'Opplev-kort',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.title || 'Kort' }) },
            fields: [
          ...
          },
          {
            ...
            label: 'Gjestesitater',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.source || 'Sitat' }) },
            fields: [
              {
                type: 'string',
                name: 'quote',
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Seksjoner',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.heading || '(Uten overskrift)' }) },
      ...
      },
      {
        ...
        fields: [
          ...pageHeaderFields,
          {
            ...
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.name || 'Person' }) },
            fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Priser',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.label || 'Pris' }) },
            fields: [
      ...
      },
      {
        ...
        fields: [
          ...pageHeaderFields,
          {
            ...
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.heading || 'Seksjon' }) },
            fields: [
              ...
              { type: 'string', name: 'photoCredit', label: 'Fotokreditt (valgfritt)' },
              {
                ...
                label: 'Bilder',
                list: true,
                ui: { itemProps: (item: any) => ({ label: item?.alt || 'Bilde' }) },
                fields: [
      ...
      // === COLLECTIONS ===
      {
        ...
        fields: [
          ...
          { type: 'number', name: 'sortOrder', label: 'Sorteringsrekkefølge' },
        ],
      },
      {
        name: 'nyheter',
