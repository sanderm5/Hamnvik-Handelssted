      ...
      },
      {
        ...
        fields: [
          ...pageHeaderFields,
          {
            type: 'object',
            name: 'sections',
            label: 'Oppdateringer (nyeste først)',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.heading || '(Uten overskrift)' }) },
            fields: sectionFields,
          },
      ...
      // === SINGLETONS — ENGLISH ===
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Guest quotes',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.source || 'Quote' }) },
            fields: [
              {
                type: 'string',
                name: 'quote',
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Sections',
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.heading || '(No heading)' }) },
            fields: sectionFields,
          },
        ],
      },
      ...
      },
      {
        ...
        fields: [
          ...pageHeaderFields,
          {
            ...
            list: true,
            ui: { itemProps: (item: any) => ({ label: item?.heading || 'Section' }) },
            fields: [
